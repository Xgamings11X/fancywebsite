                ...
                <div style={{display:'grid',gap:18}}>
                  ...
                  <div style={{background:'rgba(0,180,255,0.03)',border:'1px solid rgba(0,180,255,0.12)',borderRadius:12,padding:'18px 20px'}}>
                    ...
                    <p style={{fontSize:12,color:'var(--text-muted)',marginBottom:16}}>
                      Gambar tampil sebagai background di <strong style={{color:'#fff'}}>semua halaman</strong> (blur otomatis). Disarankan: <strong style={{color:'#fff'}}>1920×1080px</strong>, format JPG/PNG.
                    </p>
                    <div style={{display:'grid',gridTemplateColumns:'1fr 1fr',gap:16}}>
                      <ImageUpload
                        ...
                        hint="JPG/PNG · Maks 5MB · 1920×1080px"
                        previewSize={80}
                        maxMB={5}
                        adminToken={typeof window!=='undefined' ? localStorage.getItem('admin_token')||'' : ''}
                      />
                      <ImageUpload
                        ...
                        hint="JPG/PNG · Maks 5MB · 9:16 ratio"
                        previewSize={80}
                        maxMB={5}
                        adminToken={typeof window!=='undefined' ? localStorage.getItem('admin_token')||'' : ''}
                      />
