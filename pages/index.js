  ...
  return (
    <>
      <Head>
        ...
        {/* Font Awesome dimuat async di _document.js — dihapus dari sini agar tidak blokir render */}
      </Head>
        ...
        <div className="anim-hero anim-d1" style={{margin:'0 auto 32px',display:'flex',alignItems:'center',justifyContent:'center',position:'relative',zIndex:1}}>
          {s.logo_url
            ? <img
                ...
                loading="eager"
                decoding="async"
                style={{maxWidth:180,maxHeight:180,display:'block',background:'transparent',objectFit:'contain',filter:'drop-shadow(0 8px 32px rgba(255,107,0,0.45))',animation:'logoFloat 3.5s ease-in-out infinite'}}
              />
